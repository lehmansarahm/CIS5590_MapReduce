...
public class CountryTokenRank {
	...
	private String[] rankedTokens = new String[BaseWordCount.TokenizerMapper.TARGET_WORDS.length + 1];
	
	private String countryName;
	private List<String> matchingCountries = new ArrayList<String>();
	
	public CountryTokenRank() {
	...
	public void parseToken(String line) {
		...
		String[] tokenCountString = countryTokenCount[1].split("\t");
